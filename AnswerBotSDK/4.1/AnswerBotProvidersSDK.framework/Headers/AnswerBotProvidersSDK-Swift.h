...
SWIFT_CLASS("_TtC21AnswerBotProvidersSDK28ZDKAnswerBotSettingsProvider")
@interface ZDKAnswerBotSettingsProvider : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
+ (void)getAnswerBotSettingsWithCallback:(void (^ _Nonnull)(ZDKAnswerBotSettings * _Nullable))callback;
@end
